 ...
 * @author Gloire Salva
 */
public class AlerteCyber extends javax.swing.JFrame {
    ...
    public ArrayList <ClasseAlerte> getTarifList()
    {
            ...
            String query = "Select * from frequentationsccybercafe,abonnes where date_frequentation ='"+date+"' AND '"+heure+"' >= HEURE_SORTIE AND frequentationsccybercafe.id_abonne=abonnes.id_abonne ORDER BY heure_sortie DESC";
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("C:\\Users\\Gloire Salva\\Desktop\\Apple\\literature-64.png")); // NOI18N
        ...
        jLabel4.setText("CYBER-CAFE DU CAMPUS NUMERIQUE FRANCOPHONE DE BUKAVU");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AlerteCyber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AlerteCyber().setVisible(true);
            }
        });
    }
