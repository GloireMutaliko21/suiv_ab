 ...
 * @author Gloire Salva
 */
public class FreqCyberAdmin extends javax.swing.JFrame {
    int heureSyst = 0;
    /**
     * Creates new form FreqCyberAdmin
     */
    public FreqCyberAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FREQUENTATION CYBER CAFE");
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        AlerteCyber al = new AlerteCyber();
        al.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FreqCyberAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FreqCyberAdmin().setVisible(true);
            }
        });
    }
