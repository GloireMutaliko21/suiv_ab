 ...
 * @author Gloire Salva
 */
public class ImpressionFreqCyber extends javax.swing.JFrame {
    
   Connexion connect = new Connexion();
   int heureSyst = 0;
   
    public ImpressionFreqCyber() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("LISTES DES FREQUENTATIONS DU CYBER-CAFE");
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jRadioJour, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//        mE.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            .columns(
                ...
                Columns.column("ORDI", "code_ordi", DataTypes.stringType()),
        ...
        repor.setColumnTitleStyle(columnTitleStyle).highlightDetailOddRows().title(cmp.text("CAMPUS NUMERIQUE FRANCOPHONE PARTENAIRE DE BUKAVU\nC.N.F.P/BUKAVU\n").setStyle(boldCenteredStyle).setStyle(titleStyle));
                if(jRadioJour.isSelected()){
                    repor.setDataSource("select * from frequentationsccybercafe,abonnes,ordinateurs where date_frequentation ='"+date+"'and frequentationsccybercafe.id_abonne=abonnes.id_abonne and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi ORDER BY num_frequentation ASC", connect.ConnecterBDD())
                    .title(
                        Components.text("FREQUENTATIONS JOURNALIERES CYBER-CAFE DU "+date+"\n")
                    ...
                    repor.setDataSource("select * from frequentationsccybercafe, abonnes, ordinateurs where date_frequentation like '"+ref+"%' and frequentationsccybercafe.id_abonne=abonnes.id_abonne and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi ORDER BY num_frequentation ASC", connect.ConnecterBDD())
                    .title(
                        Components.text("FREQUENTATIONS DU CYBER-CAFE DU MOIS DE "+ChoixMois.getSelectedItem()+"/"+ChoixAnnee.getYear()+"\n")
                        .setHorizontalAlignment(HorizontalAlignment.CENTER).setStyle(boldCenteredStyle).setStyle(titleStyl));
                }else if(jRadioAnnee.isSelected()){
                    repor.setDataSource("select * from frequentationsccybercafe, abonnes, ordinateurs where date_frequentation like'%"+ChoixAnnee2.getYear()+"%' and frequentationsccybercafe.id_abonne=abonnes.id_abonne and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi ORDER BY num_frequentation ASC", connect.ConnecterBDD())
                    .title(
                        Components.text("FREQUENTATIONS DU CYBER-CAFE DE L'ANNEE "+ChoixAnnee2.getYear()+"\n")
                        .setHorizontalAlignment(HorizontalAlignment.CENTER).setStyle(boldCenteredStyle).setStyle(titleStyl));
                }else if(jRadioTout.isSelected()){
                    repor.setDataSource("select * from frequentationsccybercafe, abonnes, ordinateurs where frequentationsccybercafe.id_abonne=abonnes.id_abonne and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi ORDER BY num_frequentation ASC", connect.ConnecterBDD())
                    .title(
                        Components.text("TOUTES LES FREQUENTATIONS DU CYBER-CAFE\n")
                        .setHorizontalAlignment(HorizontalAlignment.CENTER).setStyle(boldCenteredStyle).setStyle(titleStyl));
                }else if(jRadioMoisSexe.isSelected()){
                    String ref = ChoixAnnee3.getValue()+"-"+ChoixMois2.getSelectedItem();
                    repor.setDataSource("select * from frequentationsccybercafe,abonnes, ordinateurs where date_frequentation like '"+ref+"%' and frequentationsccybercafe.id_abonne=abonnes.id_abonne and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi and abonnes.sexe ='"+ChoixSexe1.getSelectedItem()+"'ORDER BY num_frequentation ASC", connect.ConnecterBDD())
                    .title(
                        Components.text("FREQUENTATIONS DU CYBER-CAFE  "+ChoixMois2.getSelectedItem()+"/"+ChoixAnnee3.getYear()+" ABONNES DU SEXE "+ ChoixSexe1.getSelectedItem()+"\n")
                        .setHorizontalAlignment(HorizontalAlignment.CENTER).setStyle(boldCenteredStyle).setStyle(titleStyl));
                }else if(jRadioAnneeSexe.isSelected()){
                    repor.setDataSource("select * from frequentationsccybercafe,abonnes, ordinateurs where date_frequentation like'%"+ChoixAnnee4.getYear()+"%' and frequentationsccybercafe.id_abonne=abonnes.id_abonne and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi and abonnes.sexe ='"+ChoixSexe2.getSelectedItem()+"'ORDER BY num_frequentation ASC", connect.ConnecterBDD())
                    .title(
                        Components.text("FREQUENTATIONS DU CYBER-CAFE  "+ChoixAnnee4.getYear()+" / ABONNES DU SEXE "+ ChoixSexe2.getSelectedItem()+"\n")
                        .setHorizontalAlignment(HorizontalAlignment.CENTER).setStyle(boldCenteredStyle).setStyle(titleStyl));
                }else if(jRadioMoisProfession.isSelected()){
                    String ref = ChoixAnnee5.getValue()+"-"+ChoixMois3.getSelectedItem();
                   repor.setDataSource("select * from frequentationsccybercafe,abonnes,ordinateurs where date_frequentation like '"+ref+"%' and frequentationsccybercafe.id_abonne=abonnes.id_abonne and abonnes.profession ='"+Profession1.getSelectedItem()+"'and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi", connect.ConnecterBDD())
                   .title(
                   Components.text("FREQUENTATIONS DU CYBER-CAFE  "+ChoixMois3.getSelectedItem()+"/"+ChoixAnnee5.getYear()+" ABONNES DONT LA PROFESSION EST "+ Profession1.getSelectedItem()+"\n")
                   .setHorizontalAlignment(HorizontalAlignment.CENTER).setStyle(boldCenteredStyle).setStyle(titleStyl));
                }else if(jRadioAnneeProfession.isSelected()){
                    repor.setDataSource("select * from frequentationsccybercafe,abonnes,ordinateurs where date_frequentation like'%"+ChoixAnnee6.getYear()+"%' and frequentationsccybercafe.id_abonne=abonnes.id_abonne and abonnes.profession ='"+Profession2.getSelectedItem()+"'and frequentationsccybercafe.code_ordi=ordinateurs.code_ordi", connect.ConnecterBDD())
                   .title(
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImpressionFreqCyber.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImpressionFreqCyber().setVisible(true);
            }
        });
    }
