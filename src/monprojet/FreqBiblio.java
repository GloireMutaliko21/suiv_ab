 ...
 * @author Gloire Salva
 */
public class FreqBiblio extends javax.swing.JFrame {
    int heureSyst = 0;
    /**
     * Creates new form FreqBiblio
     */
    public FreqBiblio() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jMenuItem1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/images/LIVRE MENU.png"))); // NOI18N
        jMenuItem1.setText("Menu Livres");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FreqBiblio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FreqBiblio().setVisible(true);
            }
        });
    }
