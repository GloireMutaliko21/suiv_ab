 ...
 * @author Gloire Salva
 */
public class Frequentation extends javax.swing.JFrame {
    int heureSyst = 0;
    /**
     * Creates new form Frequentation
     */
    ...
    private void initComponents() {
        ...
        jMenuItem4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/images/AB MENU.png"))); // NOI18N
        ...
        jMenuItem6.setText("Gestion des Paiements");
    ...
    private void btn_suivantActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suivantActionPerformed
        ...
        {
            FreqCyberAdmin FrqCyb = new FreqCyberAdmin ();
            this.setVisible(false);
            FrqCyb.pack();
        ...
        {
            FreqBiblioAdmin FrqBibl = new FreqBiblioAdmin ();
            this.setVisible(false);
            FrqBibl.pack();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frequentation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Frequentation().setVisible(true);
