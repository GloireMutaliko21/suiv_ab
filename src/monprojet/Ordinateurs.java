 ...
 * @author Gloire Salva
 */
public class Ordinateurs extends javax.swing.JFrame {
    int heureSyst = 0;
    /**
     * Creates new form Ordinateurs
     */
    public Ordinateurs() {
        initComponents();
    ...
    private void jMenuItem6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem6ActionPerformed
        ...
        FreqCyber fcyber = new FreqCyber();
        fcyber.pack();
        fcyber.setLocationRelativeTo(null);
        fcyber.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ordinateurs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ordinateurs().setVisible(true);
            }
        });
    }
