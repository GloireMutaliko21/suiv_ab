 ...
 * @author Gloire Salva
 */
public class AbonnementFini extends javax.swing.JFrame {

    Connexion connect = new Connexion();
    int heureSyst = 0;
    public AbonnementFini() {
        initComponents();
    ...
    public ArrayList <ClasseAlerte> getTarifList()
    {
            ...
            String query = "Select * from paiement,abonnes where '"+exp+"' >= date_expiration AND paiement.id_abonne=abonnes.id_abonne ORDER BY date_expiration DESC";
        ...
        try {
            ...
            while (rs.next())
            {
                tarf = new ClasseAlerte(rs.getInt("id_abonne"), rs.getString("nom_postnom_ab"), rs.getString("prenom_ab"), rs.getString("date_expiration"));
                listeTarifEt.add(tarf);
                String nom = rs.getString("nom_postnom_ab");
            }
        } catch (SQLException ex) {
            Logger.getLogger(AbonnementFini.class.getName()).log(Level.SEVERE, null, ex);
        }
        return listeTarifEt;
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID ABONNE", "NOM ET POSTNOM", "PRENOM", "DATE DE FIN"
            }
        ));
        ...
        jLabel3.setText("LISTE DES ABONNEMENTS FINIS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AbonnementFini.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AbonnementFini().setVisible(true);
            }
        });
    }
